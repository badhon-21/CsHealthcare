...
{
    public class IMMUNOLOGICALController : Controller
    {
        ...
        public IMMUNOLOGICALController()
        {
            BaseController(new Modelfactory(), new AppServices());
        }
        // GET: Hospital/IMMUNOLOGICAL
        ...
        {
            var Immunology = AppServices.IMMUNOLOGICALRepository.Get().Select(ModelFactory.Create).ToList();
            return PartialView("_List", Immunology);
        ...
        [HttpPost]
        public ActionResult Create(IMMUNOLOGICALModel immunologicalModel)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var immunological = ModelFactory.Create(immunologicalModel);

                    AppServices.IMMUNOLOGICALRepository.Insert(ModelFactory.Create(immunologicalModel));
            ...
            return View(immunologicalModel);
        }

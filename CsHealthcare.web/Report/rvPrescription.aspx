<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rvPrescription.aspx.cs" Inherits="CsHealthcare.Report.rvPrescription" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer  CssClass="rptPrint" ID="appReportViewer" runat="server" Width="680px" Height="808px" ShowPrintButton="true"
